  ...
  return (
    <div className='flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t'>
      ...
      <div className="min-w-60">
        ...
        <div className={`bg-amber-300 border border-gray-400 pl-5 py-3 mt-6 ${showFilter?'':'hidden'} sm:block`}>
          <p className="mb-3 text-sm font-medium">CATEGORIES</p>
          <div className="flex flex-col gap-2 text-sm font text-gray-800">
        ...
        {/* sub-Category */}
        <div className={`bg-amber-300 border border-gray-400 pl-5 py-3 my-5 ${showFilter?'':'hidden'} sm:block`}>
