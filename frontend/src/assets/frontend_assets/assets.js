...
export const products = [
    {
        _id: "aaaaa",
        name: "Women Boyfriend Shirt",
        description: "A lightweight,over-sized, pullover shirt,  worn as an outer garment.",
        price: 100,
        image: [p_img1],
        category: "Women",
        subCategory: "Topwear",
    ...
    {
        _id: "aaaaq",
        name: "Parachute Pants: Grey Camo",
        description: "Rock the parachute pants with a graphic tee and sneakers for an easy laid-back look. Whether you're hitting the streets or chilling at home, these pants are the perfect choice",
        price: 150,
        image: [p_img3],
        category: "Men",
